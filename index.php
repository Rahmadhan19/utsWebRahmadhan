    ...
    <div class="wrap">
        ...
        <div class="sidebar">
            <ul>
                ...
                <li><a href="<?php $_SERVER['PHP_SELF']; ?>?op=segitiga">Menghitung Segitiga</a></li>
        ...
        <div class="content"><center>
            ...
            <h2>Hallo</h2>
            <table>
                <tr><td>Nama</td><td>:</td><td>Rahmadhan Adinugroho</td></tr>
                <tr><td>NIM</td><td>:</td><td>11180910000046</td></tr>
                <tr><td>Prodi</td><td>:</td><td>Teknik Informatika</td></tr>
                </table>
                <p>Terima Kasih</p> 
            </form>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=pendaftaran">
                <table border="10" cellpadding="25px">
            ...
            <table>
                <tr><td>Masukkan Tinggi Badan Anda dalam Cm</td><td>:</td><td><input type="text" name="tb"></td></tr>
                <tr><td>Masukkan Berat Badan Anda dalam Kg</td><td>:</td><td><input type="text" name="bb"></td></tr>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=usia">
                <table>
                    <tr><td>Masukkan Usia Anda dalam tahun</td><td>:</td><td><input type="text" name="yo"></td></tr>
                    <tr><td></td><td></td><td><input type="submit" name="Submit" value="Submit"></td></tr>
                </table>
            </form>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=persegiPanjang">
                <table>
                  <tr><td>Masukkan Panjang Persegi Panjang</td><td>:</td><td><input type="text" name="panjang"></td><td>Cm</td></tr>
                  <tr><td>Masukkan Lebar Persegi Panjang</td><td>:</td><td><input type="text" name="lebar"></td><td>Cm</td></tr>  
                </table>
            ...
            { 
              $tinggi=$_POST['tb'];
                ...
                $usia=$_POST['yo'];
                    ...
                    {
                        echo "<p>Status : Anak Kecil.</p>";
                    }else if($usia > 16.5 && $usia <= 30.5)
                    {
                        echo "<p>Status : Anak Muda</p>";
                    }else if($usia > 30.5 && $usia <= 65.5)
                    {
